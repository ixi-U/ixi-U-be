...
public record PlanDetailResponse(String name, PlanState planState, Integer mobileDataLimitMb,
                                 Integer sharedMobileDataLimitMb, Integer callLimitMinutes,
                                 Integer messageLimit, Integer monthlyPrice, String planType,
                                 String usageCautions, Integer mobileDataThrottleSpeedKbps,
                                 Integer minAge, Integer maxAge, Double pricePerKb, String etcInfo,
    ...
    public static PlanDetailResponse from(Plan plan) {
        ...
        return new PlanDetailResponse(plan.getName(), plan.getPlanState(),
                plan.getMobileDataLimitMb(), plan.getSharedMobileDataLimitMb(),
                plan.getCallLimitMinutes(), plan.getMessageLimit(), plan.getMonthlyPrice(),
                plan.getPlanType().name(), plan.getUsageCautions(),
                plan.getMobileDataThrottleSpeedKbps(), plan.getMinAge(),
                plan.getMaxAge(), plan.getPricePerKb(), plan.getEtcInfo(),
